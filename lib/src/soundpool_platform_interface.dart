...
abstract class SoundpoolPlatform {
  SoundpoolPlatform();

  static SoundpoolPlatform instance = MethodChannelSoundpoolPlatform();

  /// Initializes Soundpool
  ///
  /// Completes with value >=0 if operation was successful
  Future<int> init(
      int streamType, int maxStreams, Map<String, dynamic> plaformOptions) {
